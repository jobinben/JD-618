...
let inviteCodes = ['yyN6H1cWlYMjfoObW5h_1s8YuJH3bXJPDrKvpTzf9CEY@RtGKzb2nQlmld4CSH9U1hJ4S4N9F9Zbq8TQT-VWNX5WS7v58lg@RtGKk5XtJVDeKOrSYbJomngXVXj-XL6jAe_6xfsLQ75r4Itz@RtGKze6tEFmnKoDLFt061FyMYRv7lgObF14ISgZtcvZoO95QXw@H4znHmsTlLQspxgywX2rA6NFVM8TSDg8yhuclatynZ9JWuI0yCT3']
!(async () => {
  if (!cookiesArr[0]) {
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({url: `https://raw.githubusercontent.com/inoyna11/Write-files/master/shareCodes/jd_city.json`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
