...
async function mr() {
  ...
  let client = new WebSocket(`wss://https://xinruimz-isv.isvjcloud.com/api/auth?token=${$.token}`,null,{
    headers:{
  ...
  console.log(`wss://https://xinruimz-isv.isvjcloud.com/api/auth?token=${$.token}`)
  client.onopen = async () => {
